            ...
            <div class="row">
              ...
              1-2 2-2h4V2c0-1 1-2 2-2s2 1 2 2v2h4c1 0 2 1 2 2v4h-2c-1 0-2 1-2 2s1 2 2 2h2z "/>
                            ...
                            @endif
                             ...
                             <li class="nav-item ">
                                <a class="nav-link" href="#contributor-badge" aria-controls="contributor-badge" role="tab" data-toggle="tab">
                                    <svg class="icon-20 " xmlns="http://www.w3.org/2000/svg " viewBox="0 0 512 512 ">
                                        <!-- <path d="M20 14v4c0 1-1 2-2 2h-4v-2c0-1-1-2-2-2s-2 1-2 2v2H6c-1 0-2-1-2-2v-4H2c-1 0-2-1-2-2s1-2 2-2h2V6c0-1 1-2 2-2h4V2c0-1 1-2 2-2s2 1 2 2v2h4c1 0 2 1 2 2v4h-2c-1 0-2 1-2 2s1 2 2 2h2z "/> -->
              ...
              1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z " />
                ...
                <div class="col-md-9">
                    ...
                    <!-- Security -->
                        ...
                        <div role="tabcard" class="tab-pane" id="contributor-badge">
                            @include('spark::settings.contributor-badge')
                        </div>
