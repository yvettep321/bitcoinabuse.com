<html>
	...
	<div class="big-banner" style="max-height: 250px;">
		<div class="big-content">
	        ...
	        <h1>Track & trace Crypto transactions</h1>
	        <h2>Follow the money with our visual forensics platform <b>QLUE</b>.</h2>
	    ...
	    <small class="big-float-text">Part of BIG's Compliance Suite</small>
